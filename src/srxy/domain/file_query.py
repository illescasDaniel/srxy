...
from srxy.domain.exceptions import FileQueryParseError
from srxy.domain.models import QNodeType
from srxy.domain.text import normalize_text, query_words
...
def sanitize_literal_term(text: str) -> str:
	"""Strip path separators / NULs from a Simple or multi-term leaf (invisible to users)."""
