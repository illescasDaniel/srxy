...
| **Search options** | Dialog with three sections: **Where to search** (file/folder names, file contents), **How to match** (docs/tags/metadata recommended ON, similar meaning, text in images, spoken words, visual — content how-options disabled when File contents is off), **Which files to scan** |
