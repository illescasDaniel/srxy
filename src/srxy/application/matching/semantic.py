...
def semantic_deps_unavailable_message() -> str:
	...
	return tr("unavailable.semantic_deps", hint=semantic_enable_hint())
...
def _encode_text_cached(text: str) -> object:
	...
	from srxy.adapters.outbound.cache.cache import CACHE_KIND_SEMANTIC_EMBED, cache_get, cache_put, hash_bytes
