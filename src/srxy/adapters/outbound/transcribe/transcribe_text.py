...
from srxy.adapters.outbound.metadata.media_metadata import AUDIO_SUFFIXES, VIDEO_SUFFIXES
...
def _get_faster_whisper_model(device: str):
	...
	from srxy.adapters.outbound.models.model_store import transcribe_faster_whisper_model_dir
...
def _get_transformers_pipeline(device: str):
	...
	from srxy.adapters.outbound.models.model_store import (
		...
		transcribe_transformers_model_id,
	)
...
def _cached_transcript_lines(
	...
	from srxy.adapters.outbound.cache.cache import CACHE_KIND_TRANSCRIPT, cache_get, cache_put
